...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" href="index.html">Time tracer</a>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/non-billable-codes"><i class="fa fa-list"></i> Non billable codes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/roles"><i class="fa fa-globe"></i> Roles</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/fields"><i class="fa fa-list-ul"></i> Fields</a>
                        </li>
                        <li class="nav-item">
